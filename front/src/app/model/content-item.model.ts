import { AiPipelineRunStatus } from './ai-pipeline.model';
 ...
 *  Fire-and-track, same shape as StartRunResponse: nothing has necessarily been generated by the
 *  time this resolves — `runId` is what to pass to `AiPipelineService.startPolling()` to watch the
 *  batch (content plan, then each image) actually progress. */
