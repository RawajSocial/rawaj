...
namespace Rawaj.Persistence.Migrations
{
    ...
    [Migration("20260809104900_AddFollowerCountAndPostAnalyticsSyncError")]
    partial class AddFollowerCountAndPostAnalyticsSyncError
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Rawaj.Domain.Entities.SocialMedia.PostAnalytics", b =>
                {
                    ...
                    b.HasIndex("ScheduledPostId", "RecordedAt")
            ...
            modelBuilder.Entity("Rawaj.Domain.Entities.SocialMedia.SocialAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("FollowerCountSyncedAt")
                        .HasColumnType("datetime2");
