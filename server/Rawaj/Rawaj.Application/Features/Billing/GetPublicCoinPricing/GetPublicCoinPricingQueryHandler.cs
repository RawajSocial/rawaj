...
public class GetPublicCoinPricingQueryHandler(IApplicationDbContext dbContext, ICoinCostProvider coinCostProvider)
    : IRequestHandler<GetPublicCoinPricingQuery, Result<GetPublicCoinPricingResponse>>
{
        ...
        GetPublicCoinPricingQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result<GetPublicCoinPricingResponse>.Success(new GetPublicCoinPricingResponse(
            baseCosts,
            coinPackages,
