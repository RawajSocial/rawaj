...
public record GenerateBusinessDiagnosisCommand(Guid CampaignId)
    : IRequest<Result<GenerateBusinessDiagnosisResponse>>, IRequireTenantRole, IRequireResolvedBrandAccess
{
