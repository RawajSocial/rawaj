...
public record ResearchCampaignCompetitorsCommand(Guid CampaignId)
    : IRequest<Result<ResearchCampaignCompetitorsResponse>>, IRequireTenantRole, IRequireResolvedBrandAccess
{
