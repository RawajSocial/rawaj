...
public class AcceptInvitationCommandHandler(
    ...
    : IRequestHandler<AcceptInvitationCommand, Result<Unit>>
{
    public async Task<Result<Unit>> Handle(AcceptInvitationCommand request, CancellationToken cancellationToken)
    {
        ...
        var outcome = await tenantProvisioningService.AcceptInvitationAsync(request.InvitationId, userId, user.Email, cancellationToken);
