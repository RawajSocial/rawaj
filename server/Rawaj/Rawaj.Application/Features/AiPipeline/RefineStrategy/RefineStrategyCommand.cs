...
public record RefineStrategyCommand(Guid CampaignId, string Feedback)
    : IRequest<Result<RefineStrategyResponse>>, IRequireTenantRole, IRequireResolvedBrandAccess
{
